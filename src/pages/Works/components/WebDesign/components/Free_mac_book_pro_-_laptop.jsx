...
Command: npx gltfjsx@6.2.3 free_mac_book_pro_-_laptop.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/free_mac_book_pro_-_laptop-transformed.glb')
  return (
...
useGLTF.preload('/free_mac_book_pro_-_laptop-transformed.glb')
